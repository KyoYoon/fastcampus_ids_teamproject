...
final class MusicPlayerTransitionAnimation : TransitionAnimatable {
    ...
    fileprivate weak var rootVC: ContainerViewController!
    fileprivate weak var modalVC: MusicPlayerViewController!
...
//    private var tabBarStartFrame: CGRect
    ...
    init(rootVC: ContainerViewController, modalVC: MusicPlayerViewController) {
        self.rootVC = rootVC
...
//            self.rootVC.tabBar.frame.origin.y = min(max(tabY, self.tabBarStartFrame.origin.y), tabEndOriginY)
            ...
            self.rootVC.miniPlayerView.alpha = alpha + 0.5
//            self.rootVC.tabBar.alpha = alpha
            ...
            // tabBar
//            let tabStartOriginY = self.rootVC.miniPlayerView.bounds.size.height
